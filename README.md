...
Данные школы Современного Таро для сайта — `webapp/js/data_roman.js` (генерируется из research-материалов).
...
Материалы школы пана школой — конспекты открытых лекций YouTube (2020–2021), для личного использования.
