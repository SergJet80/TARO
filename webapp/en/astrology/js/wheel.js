...
(function () {
  ...
  // извлечь два куспид-числа из строки дат вида "March 20/21 – April 20/21"
  ...
  function renderDetail(i) {
    ...
    panel.innerHTML =
      '<div class="zd-head">' +
        ...
        "<p class=\"zd-code\">Keyword: " + s.code + '</p></div>' +
      '</div>' +
      '<div class="zd-grid">' +
        "<div class=\"zd-cell\"><span class=\"zd-label\">House<\/span><span class=\"zd-val\">" + s.house + '</span></div>' +
        "<div class=\"zd-cell\"><span class=\"zd-label\">Planets<\/span><span class=\"zd-val\">" + s.planets + '</span></div>' +
        "<div class=\"zd-cell\"><span class=\"zd-label\">Main planet<\/span><span class=\"zd-val\">" + s.mainPlanet + '</span></div>' +
        "<div class=\"zd-cell\"><span class=\"zd-label\">Opposite sign<\/span><span class=\"zd-val\">" + s.opposite + '</span></div>' +
      '</div>' +
      '<p class="zd-text">' + s.text + '</p>' +
      "<p class=\"zd-text\"><strong>Constructive expression:<\/strong> " + s.plus + '</p>' +
      "<p class=\"zd-text\"><strong>Shadow:<\/strong> " + s.minus + '</p>' +
      '<div class="zd-month">' +
        "<p class=\"zd-label\">Dates " + s.dates + '</p>' +
        '<p class="zd-m"><strong>' + s.month + '</strong> — ' + s.work + '</p>' +
      '</div>' +
      '<div class="zd-actions">' +
        '<a class="zd-link" href="' + s.slug + "/index.html\">Open the sign page →<\/a>" +
        '<button class="zd-btn" type="button" data-opp="' + s.oppositeSlug + "\">Shadow (" + s.opposite + ')</button>' +
      '</div>';
